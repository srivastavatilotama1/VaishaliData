...
public class StudentDAOImpl extends JdbcDaoSupport implements IStudentDAO
{
	...
	public int addStudent(Student student)
	{
		...
		int result=getJdbcTemplate().update(insertQry,param);
		return result;
	...
	public int deleteStudent(Student stu)
	{
		...
		int res=getJdbcTemplate().update(delQry,param);
		return res;
	...
	public int updateFees(Student stu)
	{
		...
		int res3=getJdbcTemplate().update(updateQry,updateparam);
		return res3;	
	}
	...
	public Student getStudentByRollNo(int rollno)
	{
		...
		Student  stu=getJdbcTemplate().queryForObject(selQry,updateparam, new StudentMapper());
		return stu;	
	}
	...
	public List<Student> getAllStudent()
	{
		...
		return getJdbcTemplate().query(selQry, new StudentMapper());
