...
public class ProcessRequest extends HttpServlet
{
			...
			HttpServletResponse response)throws ServletException, IOException
	{
		...
		pw.println("Username>>" + username + "<br/>Password>>" + password
				+ "<br/>Gender>>" + gender + "<br/>Qualification>>" + qualification);
		...
		pw.println("<BR>Values checked for proofs submitted are::<BR>");
		if(proofs != null){
		...
		pw.println("<br/>Values entered for hobbies are::<BR>");
		if(hobbies != null){
